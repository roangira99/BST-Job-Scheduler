...
from main import BSTDemo, Node

# Function to handle input options on interface
...
my_tree = BSTDemo() # Creating an object of BST demo class

with open("data.txt") as f: # loading the information from the txt file
    for line in f: # Reading it line by line
        my_tree.insert(line) # Inserting it to the tree
